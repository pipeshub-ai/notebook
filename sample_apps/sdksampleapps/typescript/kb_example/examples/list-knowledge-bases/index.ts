 ...
 *
 * Fetches up to 10 KBs where the user has owner, organizer, or writer permission,
 * sorted by creation time, and prints the response.
 *
 * Run: npm run run:list   OR   npx ts-node examples/list-knowledge-bases/index.ts
 */
...
/** Lists knowledge bases (owner/organizer/writer, limit 10, by createdAt). */
